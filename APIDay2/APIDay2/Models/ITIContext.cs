...
public partial class ITIContext : DbContext
{
    ...
    public virtual DbSet<SequenceTable> SequenceTables { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.ToTable("Department", tb => tb.HasTrigger("Prevent_insert"));
        ...
        modelBuilder.Entity<SequenceTable>(entity =>
        {
